...
namespace csApiApp.Models
{
    public class DealResult : GameResult
    {
        ...
        public DealResult(int gameID, string title, string metaReviewLink, int metaReviewScore, float steamRatingPercent, int steamAppID, int releaseDate, string thumbnailLink, string dealID, decimal normalPrice, decimal salePrice, string storeID, float savingsPercentage)
